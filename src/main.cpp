...
const string strMessageExistential = "Existential Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Existential", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //block.GetHash() == 0000037f9806400d02d91489fd27fd1b132a46385d9183f61121d5c87c04b404
        //block.hashMerkleRoot == 05987e32c83106f2d27a9bd16693770e920634049c002880d70a5b3e318c5b01
        //block.nTime = 1531697560 
        //block.nNonce = 1448179

        const char* pszTimestamp = "Existential for mankind July 15 2018";
        CTransaction txNew;
        txNew.nTime = 1531697560;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 1448179 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x05987e32c83106f2d27a9bd16693770e920634049c002880d70a5b3e318c5b01"));
